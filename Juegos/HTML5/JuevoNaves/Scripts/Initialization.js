...
// Comprueba si todas las imágenes se han cargado, si así se inicia el juego.
function checkIfAllImagesLoaded() {
	
	// Si todas las imágenes se han cargado por ahora, establecer re-dibujar cada 50 ms y una nueva nave espacial cada 1000ms.
