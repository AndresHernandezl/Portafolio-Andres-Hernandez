...
// Crear una bala en la posición del defensor, y añadirlo a la matriz de todas las balas.
function fireBullet() {
...
// Dibuja todo (esta función se llama repetidamente a un temporizador, para dar la impresión de animación).
function draw() {
	drawScene();
	drawDefender();
	drawBullets();
